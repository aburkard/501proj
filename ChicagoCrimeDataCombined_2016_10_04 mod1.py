...
def main(argv):
    pullchidata('ChicagoCrime2016.tsv','https://data.cityofchicago.org/resource/6zsd-86xi.json')
    cleanchidata('ChicagoCrime2016.tsv', 'ChicagoDataMissingnoisevalues.txt','ChicagoDataCheckVals.csv','ChicagoDataCheckRanges.csv')
    chidatanewattr('ChicagoCrime2016.tsv',"ChicagoCrime2016W3newfeatures.tsv","crimeTypes.csv",'2016-09-01T00:00:00.000')
