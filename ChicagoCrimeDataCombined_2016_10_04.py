...
def main(argv):
     #open file
    with open('ChicagoCrime2016.txt', 'w') as OutFile:
        ...
        with open('ChiCrimeURLpost.csv', 'r') as urlpostfile:
    ...
    with open('ChicagoCrime2016.txt', 'r') as file:
        #read data into data frame
        Data = pd.read_table('ChicagoCrime2016.txt' , sep='\t', encoding='latin1')
        ...
        with   open('ChicagoDataMissingnoisevalues.txt', 'w' ) as outfile:
            ...
            checkrange = pd.read_csv("ChicagoDataCheckRanges.csv") 
            for y in Data:           
                try:
        ...
        #Create an attribute for reported domestic crimes where an arrest was made:
        crimeTypes = pd.read_csv("crimeTypes.csv")         
        Data['indexCrime'] = 0  
        ...
        #Write data out:
        myFileName="ChicagoCrime2016W3newfeatures.txt"
